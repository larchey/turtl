...
pub fn verify_re_encryption(ciphertext: &Ciphertext, re_encrypted: &Ciphertext) -> Result<()> {
...
pub fn verify_shared_secret_integrity(ss1: &SharedSecret, ss2: &SharedSecret) -> Result<()> {

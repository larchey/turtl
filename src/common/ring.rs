...
impl FieldElement {
    ...
    pub fn add(&self, other: &Self) -> Self {
        ...
        assert_eq!(
            ...
            "Cannot add elements from different rings"
        );
    ...
    pub fn sub(&self, other: &Self) -> Self {
        ...
        assert_eq!(
            self.modulus, other.modulus,
            "Cannot subtract elements from different rings"
        );
    ...
    pub fn mul(&self, other: &Self, context: &Montgomery) -> Self {
        ...
        assert_eq!(
            self.modulus, other.modulus,
            "Cannot multiply elements from different rings"
        );
        assert_eq!(
            self.modulus, context.modulus,
            "Context modulus doesn't match element modulus"
        );

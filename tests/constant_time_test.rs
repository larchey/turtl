...
fn test_ct_cmov_u64() {
    ...
    assert_eq!(
        ...
        "cmov_u64 with true condition should set r to x"
    );
    ...
    assert_eq!(
        r, 0xFEDCBA0987654321,
        "cmov_u64 with false condition should leave r unchanged"
    );
}
...
fn test_ct_cmov_u128() {
    ...
    assert_eq!(
        r, 0xFEDCBA0987654321FEDCBA0987654321,
        "cmov_u128 with true condition should set r to x"
    );
    ...
    assert_eq!(
        r, 0xFEDCBA0987654321FEDCBA0987654321,
        "cmov_u128 with false condition should leave r unchanged"
    );
}
...
fn test_ct_cmov_byte() {
    ...
    assert_eq!(
        r, 20,
        "cmov_byte with false condition should leave r unchanged"
    );
}
...
fn test_ct_cswap() {
    ...
    assert_eq!(
        a, 20,
        "cswap with false condition should leave a and b unchanged"
    );
    assert_eq!(
        b, 10,
        "cswap with false condition should leave a and b unchanged"
...
fn test_ct_cswap_u64() {
    ...
    assert_eq!(
        ...
        "cswap_u64 with true condition should swap a and b"
    );
    assert_eq!(
    ...
    assert_eq!(
        a, 0xFEDCBA0987654321,
        "cswap_u64 with false condition should leave a and b unchanged"
    );
    assert_eq!(
        b, 0x1234567890ABCDEF,
        "cswap_u64 with false condition should leave a and b unchanged"
...
fn test_ct_cswap_u128() {
    ...
    assert_eq!(
        a, 0xFEDCBA0987654321FEDCBA0987654321,
        "cswap_u128 with true condition should swap a and b"
    );
    assert_eq!(
    ...
    assert_eq!(
        a, 0xFEDCBA0987654321FEDCBA0987654321,
        "cswap_u128 with false condition should leave a and b unchanged"
    );
    assert_eq!(
        b, 0x1234567890ABCDEF1234567890ABCDEF,
        "cswap_u128 with false condition should leave a and b unchanged"
...
fn test_ct_cswap_byte() {
    ...
    assert_eq!(
        a, 20,
        "cswap_byte with false condition should leave a and b unchanged"
    );
    assert_eq!(
        b, 10,
        "cswap_byte with false condition should leave a and b unchanged"
...
fn test_ct_cswap_slice() {
    ...
    assert_eq!(
        a, b_orig,
        "cswap_slice with true condition should swap a and b"
    );
    assert_eq!(
        b, a_orig,
        "cswap_slice with true condition should swap a and b"
    ...
    assert_eq!(
        a, b_orig,
        "cswap_slice with false condition should leave a and b unchanged"
    );
    assert_eq!(
        b, a_orig,
        "cswap_slice with false condition should leave a and b unchanged"
...
fn test_ct_select_u128() {
    ...
    assert_eq!(
        result, y,
        "select_u128 with false condition should return y"
    );
}
...
fn test_ct_select_byte() {
    ...
    assert_eq!(
        result, y,
        "select_byte with false condition should return y"
    );
}
...
fn test_ct_eq_u32() {
    ...
    assert!(
        constant_time::ct_eq_u32(10, 10),
        "Equal values should return true"
    );
    assert!(
        !constant_time::ct_eq_u32(10, 20),
        "Unequal values should return false"
    );
}
...
fn test_ct_eq_u64() {
    ...
    assert!(
        constant_time::ct_eq_u64(0x1234567890ABCDEF, 0x1234567890ABCDEF),
        "Equal values should return true"
    );
    assert!(
        !constant_time::ct_eq_u64(0x1234567890ABCDEF, 0xFEDCBA0987654321),
        "Unequal values should return false"
    );
}
...
fn test_ct_is_zero_u32() {
    ...
    assert!(
        !constant_time::ct_is_zero_u32(10),
        "Non-zero should return false"
    );
    assert!(
        !constant_time::ct_is_zero_u32(0xFFFFFFFF),
        "Max value should return false"
    );
}
...
fn test_ct_is_zero_u64() {
    ...
    assert!(
        !constant_time::ct_is_zero_u64(10),
        "Non-zero should return false"
    );
    assert!(
        !constant_time::ct_is_zero_u64(0xFFFFFFFFFFFFFFFF),
        "Max value should return false"
    );
}
...
fn test_ct_is_zero_u128() {
    ...
    assert!(
        !constant_time::ct_is_zero_u128(10),
        "Non-zero should return false"
    );
    assert!(
        !constant_time::ct_is_zero_u128(u128::MAX),
        "Max value should return false"
    );
}
...
fn test_ct_is_zero_u8() {
    ...
    assert!(
        !constant_time::ct_is_zero_u8(10),
        "Non-zero should return false"
    );
    assert!(
        !constant_time::ct_is_zero_u8(0xFF),
        "Max value should return false"
    );
}
